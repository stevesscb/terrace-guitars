        ...
        <TwoColumnGrid>
          ...
          <div className={classes['about-column']}>
            ...
            <p>
              ...
              had to be towed to Adelaide and then put on the rail to get it
              home, needless to say all the touring funds were gone and then
              some! I then got a job in a music shop to pay off the debts and
              eight years later ... "
            </p>
            <button>
