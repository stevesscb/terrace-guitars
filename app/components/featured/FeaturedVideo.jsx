...
export default function FeaturedVideo() {
  return (
    <section className={`${classes['featured-video']} full-width-bg`}>
      <TwoColumnGrid>
        <div className={classes.description}>
          ...
          <p>
            ...
            single guitar! We shot the video after hours over 2 nights and had a
            great time getting crazy with the sounds. Check out the video here.
          </p>
        </div>
